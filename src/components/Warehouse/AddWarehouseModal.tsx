...
import { GET_BRANCH_BY_ID as GET_Warehouse_BY_ID } from "../../graphql/queries/branches/branches";
...
export const EditWarehouseModal: React.FC<EditWarehouseModalProps> = ({ open, onClose, branchId: warehouseId }) => {
   const { data, loading, error:getBranchError } = useQuery<WarehouseByIdResponse>(GET_Warehouse_BY_ID, {
  variables: {
    id: warehouseId,
  },
  skip: !warehouseId
